...
// This program answers the Questions 2j and 3 for 2-3 Tree
import java.util.*;

@SuppressWarnings("rawtypes")
class Question3b<T extends Comparable<T>> implements Iterable
{
    private Node root;
    private int size;
    ...
    public static void main(String[] args) {
    	...
    	Question3b<Integer> t = new Question3b<Integer>();
